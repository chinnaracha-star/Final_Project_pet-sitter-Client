...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/admin/owners/profile', component: () => import('../views/Admin/AdminPetOwnerView-Profile.vue') },
    { path: '/admin/owners/profile/pets', component: () => import('../views/Admin/AdminPetOwnerView-Pet.vue') },
