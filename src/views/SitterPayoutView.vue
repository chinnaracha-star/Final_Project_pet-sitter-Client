      ...
      <template v-if="payout">
        ...
        <form v-else @submit.prevent="confirming = true">
          ...
          <section class="form-card">
            ...
            <div class="fields">
              <label>Bank Account Number*<input v-model.trim="bank.accountNumber" inputmode="numeric" required /></label>
